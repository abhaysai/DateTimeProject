...
print("This is Human Readable Format:", dt1.to_human_readable_format())
...
# Validating a date
print("Is 2023-01-01 a valid date or not ?", CustomDateTime.validate_date(2023, 1, 1))
print("Is 2023-02-30 a valid date or not?", CustomDateTime.validate_date(2023, 2, 30))

# Date difference
dt3 = CustomDateTime(2023, 1, 10)
print("Difference in days:", CustomDateTime.date_difference(dt1, dt3, unit='days'))
print("Difference in weeks:", CustomDateTime.date_difference(dt1, dt3, unit='weeks'))
print("Difference in months:", CustomDateTime.date_difference(dt1, dt3, unit='months'))
